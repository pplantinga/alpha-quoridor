"""Interactive CLI game against trained network."""
...
def main() -> None:
    parser = argparse.ArgumentParser("Human vs Alpha Quoridor")
    ...
    while not state.is_terminal:
        ...
        if state.current_player == args.ai_player:
            print(f"AI (Player {args.ai_player}) is thinking...")
            move = mcts_agent.select_move(state, training=False)
